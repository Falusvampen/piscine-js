// Instructions
// Create a function named isWinner which accepts a string representing the name of a country.
// It should use the winners "API" to return a resolved Promise with an appropriate string.

// The strings which can be returned are listed below. You'll need to replace "Country"
// with the country named which is passed to isWinner:
...
// The country won the FIFA world cup fewer than 3 times.
